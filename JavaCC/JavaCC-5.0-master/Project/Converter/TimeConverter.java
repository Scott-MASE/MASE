...
class TimeConverter implements TimeConverterConstants {
  ...
  static final public void Start() throws ParseException, ParseException, NumberFormatException, TokenMgrError {
        double value = 0;
        String unit = "";
        String help = "";
        String error = "none";
  ...
  static final public String Help() throws ParseException {
    Token t;
